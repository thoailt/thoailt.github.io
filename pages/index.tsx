            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center md:text-left animate-fade-in">
                ...
                <p
                  ...
                  dangerouslySetInnerHTML={{ __html: config.bio }}
                />
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-2xl mx-auto md:mx-0">
                  <a
                    href="/about"
                    className="btn-primary flex items-center justify-center text-sm md:text-base whitespace-nowrap"
                  >
                    About
                  </a>
                  <a
                    href="/publications"
                    className="btn-secondary flex items-center justify-center text-sm md:text-base whitespace-nowrap"
                  >
                    Publications
                  </a>
                  <a
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-gray-700 mb-6 leading-relaxed">
                I'm a passionate {config.title.toLowerCase()} dedicated to
                building innovative solutions and conducting impactful research.
                With expertise spanning multiple domains, I strive to create
                technology that makes a difference.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                My work focuses on leveraging cutting-edge technologies to solve
                real-world problems. I believe in open-source collaboration and
                knowledge sharing.
              </p>
            </div>
        ...
        <div className="container-custom">
          ...
          {recentBlogPosts.length > 0 ? (
            <>
              ...
              <div className="text-center">
                <a href="/posts" className="btn-primary inline-block">
                  View All Posts →
                </a>
              </div>
            </>
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const allPublications = JSON.parse(
    fs.readFileSync(publicationsPath, "utf8")
