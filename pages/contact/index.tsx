...
export default function Contact({ config }: ContactProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitMessage('Oops! There was a problem sending your message. Please try emailing me directly.');
    } finally {
  ...
  return (
    <Layout
      ...
      description={`Get in touch with ${config.name}. I'm open to new opportunities and collaborations.`}
    >
      {/* Header Section */}
