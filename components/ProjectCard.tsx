 ...
 * Shows project title, description, tags, and links
 */
interface Project {
  id: string;
  title: string;
  ...
  return (
    <article className="card overflow-hidden h-full flex flex-col">
      ...
      <div className="relative h-48 bg-gradient-to-br from-primary-400 to-primary-600 overflow-hidden">
        ...
        {project.featured && (
          <span className="absolute top-4 right-4 bg-yellow-400 text-gray-900 px-3 py-1 rounded-full text-xs font-semibold">
            Featured
          </span>
        )}
      </div>
